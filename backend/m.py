...
def perform_fusion(pathInCTImage, pathInMRIImage, pathOfCTImageDir, pathOfMRIImageDir):
    ...
    for i in range(4):
        ...
        cv2.imwrite('jpg/fusion_{}.jpg'.format(i), fusionImage)
...
if __name__ == "__main__":
    ...
    arg.add_argument("--pathOfCTImageDir", help="Path to empty CT Image folder which contains the 4 different bands")
    arg.add_argument("--pathOfMRIImageDir", help="Path to empty MRI Image folder which contains the 4 different bands")
    args = arg.parse_args()
