...
@app.route('/upload', methods=['POST']) #uploaded images from frontend gets sotred in jpg folder with names test_ct.jpg and test_mri.jpg returning a success msg to the frontend
def upload_images():
    """Handle file uploads."""
